    ...
    def run(self, clear: bool = True) -> None:
        ...
        while self._alive and time.time() - start_time < self._config.get_duration():
            ...
            while not self.pending_tasks.empty():
                ...
                # For queueing theory we exit after scheduling 4 jobs
                # numberOfSchedulesJobs += 1
                #
                # if numberOfSchedulesJobs == 4:
                #     self.__logger.info(f"4 jobs deployed. Exiting Orchestrator")
                #     self.stop()
                #     return
